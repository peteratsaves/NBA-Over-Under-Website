...
import pandas as pd
df = pd.read_html('https://www.basketball-reference.com/leagues/NBA_2024_standings.html')
...
with open('/Users/peteratsaves/Desktop/Projects/index.js', 'w') as f:
    ...
    file2 = open('/Users/peteratsaves/Desktop/Projects/index.txt', 'r')
